...
#define WIFI_SSID "Anvil"
#define WIFI_PASSWORD "1234567890"

// For the following credentials, see examples/Authentications/SignInAsUser/EmailPassword/EmailPassword.ino

/* 2. Define the API Key */
#define API_KEY "AIzaSyCTV4sPg7LhCBBq5ZLaFXZBqyZiZWpsCgQ"

/* 3. Define the RTDB URL */
#define DATABASE_URL "https://another-a2ea3-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app

/* 4. Define the user Email and password that alreadey registerd or added in your project */
#define USER_EMAIL "mainamathengej@gmail.com"
#define USER_PASSWORD "wakaHATOLI001#"
